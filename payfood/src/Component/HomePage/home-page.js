...
import foodGif from "./Food Vlogger.gif";
          ...
          <footer className="footer">
            ...
            <div className="footer-content">
              ...
              <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
                ...
                <a className="footer-social-link linkedin" href="https://fr.linkedin.com/posts/payfood_découvrez-payfood-lapplication-tout-en-un-activity-7143215988329574400-tWtI" target="_blank">
                  <span className="hidden-link-text">Linkedin</span>
                  <svg className="footer-social-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26">
                    <path className="footer-social-icon-path" d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"></path>
                  </svg>
                </a>
                <a className="footer-social-link twitter" href="https://www.tiktok.com/@payfood" target="_blank">
                ...
                <a className="footer-social-link youtube" href="https://www.instagram.com/payfood.app/" target="_blank">
