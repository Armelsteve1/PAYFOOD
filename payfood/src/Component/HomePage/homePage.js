      ...
      <div class="pg-footer">
        <footer class="footer">
          ...
          <div class="footer-content">
            ...
            <div class="footer-content-column">
              <div class="footer-menu">
                <h2 class="footer-menu-name">Comment ça marche ?</h2>
              ...
              <div class="footer-menu">
                <h2 class="footer-menu-name">Légal</h2>
            ...
            <div class="footer-content-column">
              <div class="footer-call-to-action">
                <h2 class="footer-call-to-action-title">Rejoignez-nous !</h2>
          ...
          <div class="footer-copyright">
            <div class="footer-copyright-wrapper">
              <p class="footer-copyright-text">
                <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Payfood@Marci. | Tous droits réservés. </a>
              </p>
            </div>
          </div>
        </footer>
